...
export default function Home() {
  return (
    <main className="flex items-center justify-center h-lvh background">
      <div className="w-2/5 border gap-4 rounded-md max-w-md min-w-[21.5rem] flex flex-col items-center justify-center h-2/4 menu">
        ...
        <OSBIbutton buttonName="PLAY" width={248} primColor="rgb(53 53 53) 0%" secColor="rgb(77 77 77 / 93%) 100%" />
        <OSBIbutton buttonName="SIGN UP" width={248} primColor="rgb(53 53 53) 0%" secColor="rgb(77 77 77 / 93%) 100%" />
      </div>
    </main>
  );
}
